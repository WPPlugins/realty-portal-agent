...
//			}
		 ...
		 * Get value submit
		 */
		public static function get_value_submit( $property_id, $name_meta, $value_meta = '' ) {
			if ( ! empty( $property_id ) ) {
				if ( 'title' == $name_meta ) {
					return get_the_title( $property_id );
				} elseif ( 'description' == $name_meta ) {
					return get_post_field( 'post_content', $property_id );
				} elseif ( 'country' == $name_meta ) {
					$country      = Realty_Portal::get_post_meta( $property_id, $name_meta, $value_meta );
				...
				return Realty_Portal::get_post_meta( $property_id, $name_meta, $value_meta );
			}
